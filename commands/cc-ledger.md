---
description: Show the cc-boost failure ledger. Pretty-prints recent entries from .cc-boost/runtime/failures.jsonl grouped by error type, with frequency counts.
...
The script:
- Reads `.cc-boost/runtime/failures.jsonl`.
